  ...
  return (
    <DashboardLayout>
      ...
      <Box className="flex min-h-screen flex-col">
        {/* Tabs Header - Fixed */}
        <Box className="flex-shrink-0 border-gray-200 border-b px-4 py-2 pb-3 dark:border-gray-700">
          <Tabs.Root defaultValue="board">
            {/* Combined tabs and controls in one row */}
            <Flex justify="between" align="center" className="w-full">
              ...
              {/* UI Controls - Now on the same line */}
