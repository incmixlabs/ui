  ...
  return (
    <div className="space-y-2 pr-3 py-3 relative ">
      ...
      <ScrollArea
        ...
        className="h-[90%] w-full overflow-x-hidden focus-visible:outline-0 focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-0 py-0.5"
        style={{
          height,
        }}
      >
        <ul
          className={cn(
            "flex items-center flex-col gap-1 h-full max-h-56 w-24 px-1 py-0.5",
          )}
        >
...
const DateTimeLocalInput = ({
  ...
  return (
    <Popover>
      ...
      <PopoverContent className="w-auto p-0 border-none " sideOffset={8}>
