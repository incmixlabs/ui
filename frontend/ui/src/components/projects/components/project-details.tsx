...
function ProjectDetails() {
  ...
  const handleUpdateField = async (field: 'name' | 'company' | 'description', value: string) => {
  ...
  const handleUpdateDate = async (field: 'startDate' | 'endDate', value: number | null) => {
    if (!project?.id) return
    ...
    return (
      <Box className="space-y-4 animate-pulse">
        <Flex align={"center"} gap={"3"}>
          <Box className="h-14 w-14 bg-gray-6 rounded-xl" />
          <Box className="space-y-2">
            <Box className="h-4 w-32 bg-gray-6 rounded" />
            <Box className="h-3 w-24 bg-gray-6 rounded" />
          </Box>
        </Flex>
      </Box>
    )
    ...
    <>
      ...
      <Box className="space-y-2 py-6 pt-4">
        ...
        <Flex justify="between" className="pt-1">
          <Flex gap="3">
            <Box
              className="grid h-10 w-10 place-content-center rounded-lg bg-green-3 text-green-8"
            >
              <DollarSign />
            </Box>
            <Box>
          ...
          <Flex gap="3">
            <Box
              className="grid h-10 w-10 place-content-center rounded-lg bg-blue-3 text-blue-8"
            >
              <CalendarDays />
            </Box>
            <Box>
          ...
          <Flex gap="3">
            <Box
              className="grid h-10 w-10 place-content-center rounded-lg bg-orange-3 text-orange-8"
            >
              <CalendarDays />
            </Box>
            <Box>
