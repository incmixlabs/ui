...
export default function TaskCardDrawer({
  ...
  return (
    <>
      <>
        <Sheet open={open} setOpen={setOpen} kanbanFilter={kanbanFilter}>
          <>
            <ScrollArea className="h-full">
              <Flex align={"center"} className="h-full  ">
                <Box className="dark:bg-gray-3 bg-gray-1 p-4 ">
                  <Flex align={"center"} justify={"between"}>
                    <Flex className=" gap-2">
                      <Button className="flex items-center gap-1  h-10 rounded-md font-semibold text-white">
                        <Check size={16} />
                        Complete
                      </Button>
                      <DropdownMenu.Root>
                        <DropdownMenu.Trigger className="">
                          <Button
                            color="gray"
                            variant="soft"
                            className="p-2 gap-2 px-2 cursor-pointer  h-10 border  rounded-md "
                          >
                            <Eye size={16} />
                            <span>2</span>
                    ...
                    <Flex className=" gap-2">
                      <IconButton
                        color="gray"
                        variant="soft"
                        className="flex items-center gap-1  rounded-md font-semibold bg-transparent"
                      >
                        <Link size={20} />
                      </IconButton>
                      ...
                      {kanbanFilter && (
                        <IconButton
                          ...
                          className="  ml-2 w-8 h-8 rounded-md flex items-center justify-center"
                        >
                          <X aria-hidden="true" />
                  ...
                  {/* template progress */}
                  <Heading className="py-4 px-0 font-medium">
                    Template Progress
                  </Heading>
                  {kanbanFilter && (
                        ...
                        >
                          {attachment.type === "image" ? (
                            ...
                            <Box className="w-16 h-16 border border-gray-8 rounded-lg flex items-center justify-center flex-shrink-0">
                              <FileArchive className="w-8 h-8 text-gray-8" />
                            </Box>
                          )}
                ...
                {!kanbanFilter && (
                  <Box className="w-72 flex-shrink-0  h-full relative pt-24">
                    <IconButton
                      ...
                      variant="soft"
                      onClick={() => setOpen(false)}
                      className="absolute top-5 right-3  ml-8 w-8 h-8 rounded-md flex items-center justify-center"
                    >
                      <X aria-hidden="true" />
                      <span className="sr-only">Close</span>
                    </IconButton>
