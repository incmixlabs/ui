...
import { getColumnData, isCardData, isCardDropTargetData, isColumnData, isDraggingACard, isDraggingAColumn, TCardData, TColumn } from './types';
...
export function Column({ column }: { column: TColumn }) {
  ...
  return (
    <div className="flex w-full flex-1 flex-shrink-0 select-none flex-col" ref={outerFullHeightRef}>
      <div
      ...
      >
        ...
        >
          ...
          <div className="flex justify-center gap-2 p-3">
            <button
              type="button"
              className="rounded bg-blue-600/10 p-2 text-2xl font-bold text-blue-500 hover:bg-blue-600 hover:text-white"
