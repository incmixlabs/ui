...
export function SecondarySidebar({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "fixed top-0 z-10 flex h-screen w-[270px] flex-col border border-y-0 border-r-gray-6 border-l-0 bg-sidebar-background transition-[left,opacity] duration-300 ease-in-out",
          open
