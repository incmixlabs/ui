          ...
          <Flex >
            ...
            <Box className="flex-1 border-r border-gray-4">
              <Card.Header className="pb-4">
                ...
                <Text as="p" className="text-sm text-gray-11">Total 840 Task Completed</Text>
              </Card.Header>
                    ...
                    return (
                      <Flex align="center" key={index} >
                        ...
                        <Box className="flex-1 relative h-8">
                          ...
                          >
                            <Badge
                              className={`${item.color} text-white border-none px-3 py-2 rounded-full text-xs font-medium w-full text-center`}
                            >
                              {item.project}
                            </Badge>
                          </Box>
                ...
                {projectList.map((project, index) => (
                  <Flex align="center" key={index} className="gap-3 p-3 rounded-lg  hover:bg-gray-3 cursor-pointer  transition-colors">
                    ...
                    <Box className="flex-1">
                      <Heading size={"2"} className="font-medium text-gray-12 ">{project.name}</Heading>
                      <Text size={"1"} className="text-gray-11">Task {project.tasks}</Text>
                    </Box>
                  </Flex>
                ))}
              </Card.Content>
