...
import { ScrollArea, Tabs } from "@base";
...
export default function NewsWidget({ country }: NewsProps) {
  ...
  return (
    <CardContainer className="min-h-96 w-full h-full px-0 overflow-hidden">
      <ScrollArea className="flex-1 overflow-hidden max-h-[calc(100%-1rem)]">
        <Tabs.Root
          value={selectedTopic}
