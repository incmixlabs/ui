...
export type ClassedProducer<V extends Variants = {}> = ((variantProps: InferVariantProps<V>) => any) & {
    _def: {
        className?: string;
        base?: string;
        variants?: V;
...
export type InferVariantProps<V extends Variants | unknown | undefined = undefined> = V extends Variants ? Partial<{
...
type ClassedCreator<Props extends {} = {}> = (variantProps?: Props & PropsWithClass) => string;
...
export type ClassedProps<T extends any[]> = ($$ClassedProps extends keyof T[0] ? T[0][$$ClassedProps] : T[0] extends {
    variants: {
        [name: string]: unknown;
    };
...
export type ClassedVariants<T extends any[]> = ($$ClassedVariants extends keyof T[0] ? T[0][$$ClassedVariants] : T[0] extends {
    variants: {
        [name: string]: unknown;
    };
...
export type ClassedCoreFunctionType = <Composers extends (string | Util.Function | {
    base?: string;
    variants?: {
        [name: string]: unknown;
    };
    ...
    [K in keyof Composers]: string extends Composers[K] ? Composers[K] : Composers[K] extends string | Util.Function ? Composers[K] : {
        ...
        compoundVariants?: (("variants" extends keyof Composers[K] ? {
            [Name in keyof Composers[K]["variants"]]?: Util.Widen<keyof Composers[K]["variants"][Name]> | Util.Widen<keyof Composers[K]["variants"][Name]>[] | Util.String;
        } : never) & {
            className?: Util.String;
            class?: Util.String;
        })[];
        dataAttributes?: "variants" extends keyof Composers[K] ? Array<keyof Composers[K]["variants"]> : string[];
    };
