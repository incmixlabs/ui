...
export type TreeItemFolder<T = Record<string, string>, U = Record<string, string>> = {
    type: "folder";
    id: string;
    name: string;
...
export type TreeDataItem<T = Record<string, string>, U = Record<string, string>> = TreeItemFile<T> | TreeItemFolder<T, U>;
