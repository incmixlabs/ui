...
import { ClipBoard, ClipBoardAdd, ClipBoardCheck, ClipBoardStatus, } from "@/components/icons";
export const taskStats = [
    {
        count: 780,
        label: "Total Tasks",
        icon: _jsx(ClipBoard, { size: "20" }),
        backgroundColorClass: "bg-indigo-3",
    },
    {
        count: 136,
        label: "New Tasks",
        icon: _jsx(ClipBoardAdd, { size: "20" }),
        backgroundColorClass: "bg-orange-3",
    },
    {
        count: 324,
        label: "In Progress",
        icon: _jsx(ClipBoardStatus, { size: "20" }),
        backgroundColorClass: "bg-amber-3",
    },
    {
        count: 215,
        label: "Done Tasks",
        icon: _jsx(ClipBoardCheck, { size: "20" }),
