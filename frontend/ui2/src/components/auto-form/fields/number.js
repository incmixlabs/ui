 ...
 */
export default function AutoFormNumber({ label, isRequired, fieldProps, }) {
    ...
    return (_jsxs("div", { className: "flex flex-col space-y-2", children: [showLabel && (_jsx("div", { className: "mb-2", children: _jsx(AutoFormLabel, { label: label, isRequired: isRequired, className: "w-auto font-medium text-base" }) })), _jsxs("div", { className: "relative", children: [isCurrency && (_jsx("span", { className: "-translate-y-1/2 absolute top-1/2 left-3 text-gray-500", children: "$" })), _jsx(Form.Control, { children: _jsx(Input, { type: "number", ...fieldPropsWithoutShowLabel, className: `h-14 w-full rounded-lg ${isCurrency ? "pl-8" : "px-4"}`, placeholder: fieldPropsWithoutShowLabel.placeholder || "0.00" }) })] }), _jsx("div", { className: "min-h-[24px] px-1 pt-1", children: _jsx(Form.Message, { className: "block max-w-full whitespace-normal break-words text-red-500 text-sm" }) })] }));
}
