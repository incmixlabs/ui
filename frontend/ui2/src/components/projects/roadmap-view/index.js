...
export function RoadmapView() {
    return (_jsxs(Box, { className: "h-full w-full overflow-hidden", children: [_jsx(Heading, { className: "mb-6 font-bold text-2xl", children: "Project Timeline" }), _jsx(GanttChart, { projectTasks: tasks })] }));
}
