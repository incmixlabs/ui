                      ...
                      >
                        ...
                        >
                          <AccordionPrimitive.Trigger
                            className={cn(
                              `mt-1 flex h-10 w-full flex-1 select-none items-center justify-between gap-1 rounded-md ${padding} font-medium text-gray-11 text-sm transition-all hover:bg-gray-4 hover:text-gray-12 hover:no-underline [&[data-state=open]>svg]:rotate-90`,
                              open && "bg-gray-4 text-gray-12"
                            )}
                          ...
                          >
                            ...
                            <ChevronRight
                              className={cn(
                                " h-5 w-5 text-gray-8 transition-transform duration-200 hover:text-gray-12",
                                open && "text-gray-12"
                              )}
                            />
                          </AccordionPrimitive.Trigger>
...
>(({ className, item, isSelected, Icon, ...props }, ref) => {
  ...
  return (
    <Flex
      ...
      gap={"2"}
      className={cn(
        `mt-1 mb-1 cursor-pointer select-none rounded-md ${padding} hover:bg-gray-4`,
        className,
        isSelected && "bg-gray-4 text-gray-12"
      )}
      {...props}
    >
      ...
      <Text
        className={cn(
          "flex-grow truncate text-gray-11 text-sm",
