...
export function applyColumnSizeConstraints<TData>(
  ...
  if (typeof constraints.width === "number") {
    ...
    typeof constraints.width === "string" &&
    /^\d+$/.test(constraints.width)
  ) {
  ...
  if (typeof constraints.minWidth === "number") {
    ...
    typeof constraints.minWidth === "string" &&
    /^\d+$/.test(constraints.minWidth)
  ) {
  ...
  if (typeof constraints.maxWidth === "number") {
    ...
    typeof constraints.maxWidth === "string" &&
    /^\d+$/.test(constraints.maxWidth)
  ) {
