import { Button, Input, Label } from "@/base"
...
const formatUrl = (url: string, _type: string, title?: string) => {
...
export function TaskRefUrlsSection({
  ...
  const handleAddRefUrl = useCallback(() => {
    ...
    const newRefUrl: TaskRefUrl = {
      ...
      title: newTitle
        ? newTitle
        : generateDefaultTitle(newUrl, urlType, refUrls),
      type: urlType,
    }
  ...
  return (
    <div className="space-y-4 py-4">
      <div className="flex items-center justify-between">
        <h3 className="font-medium text-sm">Reference URLs</h3>
        {!readonly && (
          <Button
            variant="ghost"
            ...
            >
              ...
              >
                <div className="flex items-center gap-1.5">
                  ...
                  <span>
                    {formatUrl(refUrl.url, refUrl.type, refUrl.title)}
                  </span>
                </div>
              </a>
              {!readonly && (
