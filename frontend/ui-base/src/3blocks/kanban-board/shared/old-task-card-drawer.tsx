...
import { TaskIcon } from "../../../1base/radix-ui/icons/task"
import X from "../../../1base/radix-ui/icons/x"
import type { ExtendedColorType } from "../../../2elements/combo-box"
import { ComboBox } from "../../../2elements/combo-box"
import { SmartDatetimeInput } from "../../../2elements/dates/datetime-picker"
import { MotionSheet } from "../../../4layouts/custom-sheet"
...
export function TaskCardDrawer() {
  ...
  return (
    <>
      ...
      >
        <div
          className={cn("cursor-default rounded-lg bg-gray-3 dark:bg-gray-4 ")}
        >
