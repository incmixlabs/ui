      ...
      <Dialog.Content className="max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Box>
            ...
            <Box className="max-h-32 space-y-2 overflow-y-auto rounded-md border p-2">
              {AVAILABLE_MEMBERS.map((member) => {
                const isAssigned = formData.assignedTo.find(
                  (u) => u.id === member.id
                )
                return (
                  <Flex
                    ...
                    align="center"
                    gap="3"
                    className={`cursor-pointer rounded p-2 transition-colors hover:bg-gray-50 dark:hover:bg-gray-800 ${isAssigned ? "bg-blue-50 dark:bg-blue-950" : ""}
                    `}
            ...
            {formData.assignedTo.length > 0 && (
              <Box className="mt-2">
                <Text size="1" className="mb-2 text-gray-500">
                  Selected:
                </Text>
