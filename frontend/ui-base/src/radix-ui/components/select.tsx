...
const ScrollAreaPrimitive = { Root, Viewport, Scrollbar, Thumb, Corner }

interface SelectRootProps extends SelectPrimitiveProps, SelectContextValue {}
